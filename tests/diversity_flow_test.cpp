...
//
// The DIG section (the FLOW strip's sixth step) moved out to
// tests/diversity_flow_dig_test.cpp: this file was at the 800-line budget
// AGENTS.md asks for. closedToStart()/connectGate()/openButton()/
// child<T>()/openWindow()/fire()/lastRequest() are shared by both binaries
// and live in DiversityFlowTestSupport.h so they are not duplicated.
