...
# The DiversityWindow talker table, timeline and derived event log --
# split out of diversity_window_test.cpp, which was over the 800-line
# budget AGENTS.md asks for. Same harness, same fixture.
add_executable(diversity_window_talkers_test
    tests/diversity_window_talkers_test.cpp
    src/gui/AetherGateApplet.cpp
    src/gui/AetherGateAppletControls.cpp
    src/gui/AetherGateAppletDiversity.cpp
    src/gui/AetherGateChainModes.cpp
...
target_include_directories(diversity_window_talkers_test PRIVATE src tests)
target_link_libraries(diversity_window_talkers_test PRIVATE
    aethercore Qt6::Core Qt6::Gui Qt6::Widgets Qt6::Network Qt6::Test
)
set_target_properties(diversity_window_talkers_test PROPERTIES AUTOMOC ON)
add_test(NAME diversity_window_talkers_test COMMAND diversity_window_talkers_test)
set_tests_properties(diversity_window_talkers_test PROPERTIES
    ENVIRONMENT "QT_QPA_PLATFORM=offscreen")
...
# diversity_window_test: both are at the 800-line budget AGENTS.md asks for,
# and every window case needs the same fresh, process-wide AppSettings start.
# Socket-free the same way -- the applet under it takes the injected
# QNetworkAccessManager and the window owns no transport at all.
...
target_include_directories(aether_gate_chain_test PRIVATE src tests)
target_link_libraries(aether_gate_chain_test PRIVATE
    aethercore Qt6::Core Qt6::Gui Qt6::Widgets Qt6::Network Qt6::Test
)
set_target_properties(aether_gate_chain_test PROPERTIES AUTOMOC ON)
add_test(NAME aether_gate_chain_test COMMAND aether_gate_chain_test)
set_tests_properties(aether_gate_chain_test PROPERTIES
    ENVIRONMENT "QT_QPA_PLATFORM=offscreen")

# The same window, the other story: design §0.3 -- the two bugs the operator
# found in the first build (a stale poll undoing a write; a roof select that
# looked live and was not) and the eight things he asked for. A second binary
# for the reason every window test here is its own: both files are at the
# 800-line budget AGENTS.md asks for, and both need a fresh, process-wide
# AppSettings start. The payloads and the slow gate they share live in
# tests/AetherGateChainFixture.h.
...
target_include_directories(aether_gate_chain_ux_test PRIVATE src tests)
target_link_libraries(aether_gate_chain_ux_test PRIVATE
    aethercore Qt6::Core Qt6::Gui Qt6::Widgets Qt6::Network Qt6::Test
)
set_target_properties(aether_gate_chain_ux_test PROPERTIES AUTOMOC ON)
add_test(NAME aether_gate_chain_ux_test COMMAND aether_gate_chain_ux_test)
set_tests_properties(aether_gate_chain_ux_test PROPERTIES
    ENVIRONMENT "QT_QPA_PLATFORM=offscreen")

# B21: the CHAIN window's VISUAL tab, presets, the paint budget, and the
# gestures on the picture. Same fixture and source list as the UX test.
add_executable(aether_gate_chain_b21_test
    tests/aether_gate_chain_b21_test.cpp
    src/gui/AetherGateApplet.cpp
    src/gui/AetherGateAppletControls.cpp
    src/gui/AetherGateAppletDiversity.cpp
    src/gui/AetherGateChainModes.cpp
...
target_include_directories(aether_gate_chain_b21_test PRIVATE src tests)
target_link_libraries(aether_gate_chain_b21_test PRIVATE
    aethercore Qt6::Core Qt6::Gui Qt6::Widgets Qt6::Network Qt6::Test
)
set_target_properties(aether_gate_chain_b21_test PROPERTIES AUTOMOC ON)
add_test(NAME aether_gate_chain_b21_test COMMAND aether_gate_chain_b21_test)
set_tests_properties(aether_gate_chain_b21_test PROPERTIES
    ENVIRONMENT "QT_QPA_PLATFORM=offscreen")

add_executable(aether_gate_chain_frontend_test
    tests/aether_gate_chain_frontend_test.cpp
    src/gui/AetherGateApplet.cpp
    src/gui/AetherGateAppletControls.cpp
    src/gui/AetherGateAppletDiversity.cpp
    src/gui/AetherGateChainModes.cpp
...
target_include_directories(aether_gate_chain_frontend_test PRIVATE src tests)
target_link_libraries(aether_gate_chain_frontend_test PRIVATE
    aethercore Qt6::Core Qt6::Gui Qt6::Widgets Qt6::Network Qt6::Test
)
set_target_properties(aether_gate_chain_frontend_test PROPERTIES AUTOMOC ON)
add_test(NAME aether_gate_chain_frontend_test COMMAND aether_gate_chain_frontend_test)
set_tests_properties(aether_gate_chain_frontend_test PROPERTIES
    ENVIRONMENT "QT_QPA_PLATFORM=offscreen")

add_executable(aether_gate_chain_squeeze_test
    tests/aether_gate_chain_squeeze_test.cpp
    src/gui/AetherGateApplet.cpp
    src/gui/AetherGateAppletControls.cpp
    src/gui/AetherGateAppletDiversity.cpp
    src/gui/AetherGateChainModes.cpp
...
target_include_directories(aether_gate_chain_squeeze_test PRIVATE src tests)
target_link_libraries(aether_gate_chain_squeeze_test PRIVATE
    aethercore Qt6::Core Qt6::Gui Qt6::Widgets Qt6::Network Qt6::Test
)
set_target_properties(aether_gate_chain_squeeze_test PROPERTIES AUTOMOC ON)
add_test(NAME aether_gate_chain_squeeze_test COMMAND aether_gate_chain_squeeze_test)
set_tests_properties(aether_gate_chain_squeeze_test PROPERTIES
    ENVIRONMENT "QT_QPA_PLATFORM=offscreen")

add_executable(aether_gate_chain_auto_test
    tests/aether_gate_chain_auto_test.cpp
    src/gui/AetherGateApplet.cpp
    src/gui/AetherGateAppletControls.cpp
    src/gui/AetherGateAppletDiversity.cpp
    src/gui/AetherGateChainModes.cpp
...
target_include_directories(aether_gate_chain_auto_test PRIVATE src tests)
target_link_libraries(aether_gate_chain_auto_test PRIVATE
    aethercore Qt6::Core Qt6::Gui Qt6::Widgets Qt6::Network Qt6::Test
)
set_target_properties(aether_gate_chain_auto_test PROPERTIES AUTOMOC ON)
add_test(NAME aether_gate_chain_auto_test COMMAND aether_gate_chain_auto_test)
...
add_executable(aether_gate_chain_auto_inspector_test
    tests/aether_gate_chain_auto_inspector_test.cpp
    src/gui/AetherGateApplet.cpp
    src/gui/AetherGateAppletControls.cpp
    src/gui/AetherGateAppletDiversity.cpp
    src/gui/AetherGateChainModes.cpp
...
target_include_directories(aether_gate_chain_auto_inspector_test PRIVATE src tests)
target_link_libraries(aether_gate_chain_auto_inspector_test PRIVATE
    aethercore Qt6::Core Qt6::Gui Qt6::Widgets Qt6::Network Qt6::Test
)
set_target_properties(aether_gate_chain_auto_inspector_test PROPERTIES AUTOMOC ON)
add_test(NAME aether_gate_chain_auto_inspector_test COMMAND aether_gate_chain_auto_inspector_test)
set_tests_properties(aether_gate_chain_auto_inspector_test PROPERTIES
    ENVIRONMENT "QT_QPA_PLATFORM=offscreen")
...
# opened from a CLOSED start, and DiversityWindowVisible is a process-wide
# setting.
...
target_include_directories(diversity_flow_test PRIVATE src tests)
target_link_libraries(diversity_flow_test PRIVATE
    aethercore Qt6::Core Qt6::Gui Qt6::Widgets Qt6::Network Qt6::Test
)
...
# The DiversityWindow FLOW strip's sixth step, DIG -- split out of
# diversity_flow_test.cpp, which was over the 800-line budget AGENTS.md
# asks for. Same harness, same fixture.
add_executable(diversity_flow_dig_test
    tests/diversity_flow_dig_test.cpp
    src/gui/AetherGateApplet.cpp
    src/gui/AetherGateAppletControls.cpp
    src/gui/AetherGateAppletDiversity.cpp
    src/gui/AetherGateChainModes.cpp
...
target_include_directories(diversity_flow_dig_test PRIVATE src tests)
target_link_libraries(diversity_flow_dig_test PRIVATE
    aethercore Qt6::Core Qt6::Gui Qt6::Widgets Qt6::Network Qt6::Test
)
set_target_properties(diversity_flow_dig_test PROPERTIES AUTOMOC ON)
add_test(NAME diversity_flow_dig_test COMMAND diversity_flow_dig_test)
set_tests_properties(diversity_flow_dig_test PROPERTIES
    ENVIRONMENT "QT_QPA_PLATFORM=offscreen")
...
# ── HEAR RAW -- the CHAIN window's momentary bypass button ─────────────────
#
# Appended after the sweep above on purpose: this target still gets its own
# offscreen ENVIRONMENT below, the same way every other GUI-touching chain
# test does, it just does not get the sweep's default TIMEOUT (300s) or the
# AETHER_WDSP_* environment the foreach loops above apply retroactively to
# every test registered before they ran. Neither one is load-bearing for a
# GUI unit test with no WDSP path in it.
add_executable(aether_gate_chain_bypass_test
    tests/aether_gate_chain_bypass_test.cpp
    src/gui/AetherGateApplet.cpp
    src/gui/AetherGateAppletControls.cpp
    src/gui/AetherGateAppletDiversity.cpp
    src/gui/AetherGateChainModes.cpp
...
target_include_directories(aether_gate_chain_bypass_test PRIVATE src tests)
target_link_libraries(aether_gate_chain_bypass_test PRIVATE
    aethercore Qt6::Core Qt6::Gui Qt6::Widgets Qt6::Network Qt6::Test
)
set_target_properties(aether_gate_chain_bypass_test PROPERTIES AUTOMOC ON)
add_test(NAME aether_gate_chain_bypass_test COMMAND aether_gate_chain_bypass_test)
...
# ── The START page's five session cards and the NEXT line at the window's foot
# (WP-B, Diversity Phase 3a rework) ─────────────────────────────────────────
#
# Its own binary for the reason every other diversity window binary is: each of
# them is at the 800-line budget AGENTS.md asks for, and every case here wants
# the same fresh, process-wide AppSettings start.
add_executable(diversity_session_page_test
    tests/diversity_session_page_test.cpp
    src/gui/AetherGateApplet.cpp
    src/gui/AetherGateAppletControls.cpp
    src/gui/AetherGateAppletDiversity.cpp
    src/gui/AetherGateChainModes.cpp
...
target_include_directories(diversity_session_page_test PRIVATE src tests)
target_link_libraries(diversity_session_page_test PRIVATE
    aethercore Qt6::Core Qt6::Gui Qt6::Widgets Qt6::Network Qt6::Test
)
set_target_properties(diversity_session_page_test PROPERTIES AUTOMOC ON)
add_test(NAME diversity_session_page_test COMMAND diversity_session_page_test)
set_tests_properties(diversity_session_page_test PROPERTIES
    ENVIRONMENT "QT_QPA_PLATFORM=offscreen"
    TIMEOUT 300)

# The DiversitySessionPage START page's NEXT strip and the frame's
# no-scroll budget -- split out of diversity_session_page_test.cpp,
# which was over the 800-line budget AGENTS.md asks for. Same harness,
# same fixture.
add_executable(diversity_session_page_next_test
    tests/diversity_session_page_next_test.cpp
    src/gui/AetherGateApplet.cpp
    src/gui/AetherGateAppletControls.cpp
    src/gui/AetherGateAppletDiversity.cpp
    src/gui/AetherGateChainModes.cpp
...
target_include_directories(diversity_session_page_next_test PRIVATE src tests)
target_link_libraries(diversity_session_page_next_test PRIVATE
    aethercore Qt6::Core Qt6::Gui Qt6::Widgets Qt6::Network Qt6::Test
)
set_target_properties(diversity_session_page_next_test PROPERTIES AUTOMOC ON)
add_test(NAME diversity_session_page_next_test COMMAND diversity_session_page_next_test)
set_tests_properties(diversity_session_page_next_test PROPERTIES
    ENVIRONMENT "QT_QPA_PLATFORM=offscreen"
    TIMEOUT 300)
